(function main(win, doc) {
    ...
    function drawColors(imageColors) {
        var ii = 0;
        var jj = 0;
        for (ii = 0; ii < imageColors.length; ii++) {
            for (jj = 0; jj < imageColors[ii]["colors"].length; jj++) {
                var div = document.createElement("div");
                div.style.width = "100px";
                div.style.height = "100px";
                div.style.display = 'inline-block';
                div.style.background = "rgba(" + imageColors[ii]["colors"][jj].join(",") + ")";
                //div.style.color = "white";
                div.innerHTML = imageColors[ii]["colors"][jj].join(",");
